            ...
            <tbody>
                ...
                <td>$row[name]</td>
                    ...
                    if ($row['status'] == "Pending") {
                        echo "<td><a href='index.php?page=manage_students&Approve=Yes&ID=$row[ID]' class='btn btn-success btn-xs'>Approve User</a></td>";
                    } else {
                        echo"<td>
...
if (isset($_GET['Approve'])) {
    $ID = $_GET['ID'];
    $result = mysqli_query($con, "UPDATE students SET status = 'Approved' WHERE ID = '$ID'");
    if ($result) {
        echo "<script>
window.location='index.php?page=manage_students&msg=Registration request approved';
</script>";
    }
}
