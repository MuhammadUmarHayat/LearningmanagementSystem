				...
				<table class="table table-bordered table-striped">
					...
					$count = mysqli_num_rows($qry);
					    ...
					    echo "<tr>
					    		...
					    		<td>
					    		<a href='index.php?page=schedule_assignment&C_ID=$row[ID]&title=$row[title]' class='btn btn-info text-black'>Add Assignment</a>
					    		</td>
					    		<td>
					    		...
					    		<td>
					    		<a href='index.php?page=add_short_quiz&C_ID=$row[ID]&title=$row[title]'  class='btn btn-default text-black'>Add Short Quiz</a>
					    		</td>
